...
some other ruleset that depends on yaml.bzl, or in a nested
...
```sh
OVERRIDE="--override_repository=yaml.bzl=$(pwd)/yaml.bzl"
echo "common $OVERRIDE" >> ~/.bazelrc
```

This means that any usage of `@yaml.bzl` on your system will point to this folder.
...
https://github.com/scottpledger/yaml.bzl/actions/workflows/tag.yaml
